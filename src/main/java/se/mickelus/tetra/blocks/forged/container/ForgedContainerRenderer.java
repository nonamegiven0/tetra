...
public class ForgedContainerRenderer implements BlockEntityRenderer<ForgedContainerBlockEntity> {
    public static final Material material = new Material(TextureAtlas.LOCATION_BLOCKS, ResourceLocation.fromNamespaceAndPath(TetraMod.MOD_ID, "block/forged_container/forged_container"));
